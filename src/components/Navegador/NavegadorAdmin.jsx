        ...
        <nav className={styles.nav}>
            ...
            <ul className={`${styles.ul} ${menuAbierto ? styles.menuOpen : ""}`}>
                ...
                <li className={styles.li}>
                    <NavLink to="/admin" className={({ isActive }) => (isActive ? styles.activo : "")}>
                        Crear Producto
                    </NavLink>
                    </li>
                ...
                <li style={{ position: "relative" }}>
                    {usuario ? (
                        <button className={styles.botonIngresar} onClick={logout}>
                            Cerrar sesión <i className="bi bi-box-arrow-left"></i>
                        </button>
                    ) : (
                    ...
                    {mostrarLogin && (
                        <div className={styles.loginFlotante}>
                            <Login accion={() => setMostrarLogin(false)} />
                        </div>
                    )}
                </li>
            </ul>
